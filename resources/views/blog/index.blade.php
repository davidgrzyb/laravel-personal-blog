...
@section('content')
    ...
    <main role="main" class="container col-md-6 pl-4">
        <div class="row">
            <div class="col blog-main @if(! $data['topics']->isNotEmpty()) pt-5 @endif">
                ...
                @if(count($data['posts']) > 0)
                    ...
                    {{ $data['posts']->links() }}
                @else
                    <h5 class="text-center summary pb-5 @if(! $data['topics']->isNotEmpty()) pt-5 @endif" style="font-weight:400;">Oops! Looks like I don't have any posts here yet 😢</h5>
                @endif
            </div>
        </div>
